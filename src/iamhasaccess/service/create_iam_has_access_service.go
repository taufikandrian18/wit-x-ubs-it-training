...
func (s *IamHasAccessService) CreateIamHasAccess(ctx context.Context, req query.InsertIamHasAccessParams) (res json.RawMessage, err error) {

	q := query.New(s.connectionString)

	res, err = q.InsertIamHasAccess(ctx, req)
	if err != nil {
